...
NAMADA_CHAIN_ID="public-testnet-12.fedec12f3428"
...
cd $HOME/namada_bin
wget -O namada.tar.gz https://github.com/anoma/namada/releases/download/v0.21.1/namada-v0.21.1-Linux-x86_64.tar.gz
